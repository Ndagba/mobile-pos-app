...
function CheckoutScreen({ onClose }) {
  ...
  return (
    <div style={{
      ...
      {/* Header */}
      <div style={{
        padding: '14px 20px 16px', display: 'flex', alignItems: 'center', gap: 12,
        background: 'var(--card)', borderBottom: '1px solid var(--border)',
      }}>
        <button onClick={onClose} style={window.iconBtn}><Icons.close size={20}/></button>
        <div style={{ flex: 1 }}>
          <div style={{ fontSize: 18, fontWeight: 700, letterSpacing: '-0.01em' }}>New Sale</div>
          <div style={{ fontSize: 12, color: 'var(--muted)' }}>
            {itemCount} {itemCount === 1 ? 'item' : 'items'} · {window.BRANCHES.find(b => b.id === branch).label}
          </div>
        </div>
      ...
      {/* Branch chips */}
      <div style={{
        display: 'flex', gap: 8, padding: '4px 20px 12px', overflowX: 'auto',
        scrollbarWidth: 'none',
      }}>
      ...
      {/* Products grid */}
      <div style={{ flex: 1, overflowY: 'auto', padding: `0 20px ${itemCount ? 160 : 100}px` }}>
            ...
            return (
              <div key={p.id} style={{
                ...
                <div style={{
                  ...
                  background: `linear-gradient(135deg, ${p.tone}22 0%, ${p.tone}08 100%)`,
                ...
                <div style={{ padding: 10 }}>
                  <div style={{ fontSize: 13, fontWeight: 600, lineHeight: 1.25, height: 32, overflow: 'hidden' }}>
                    {p.name}
                  </div>
                  <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginTop: 6 }}>
                    ...
                    {qty === 0 ? (
                      ...
                      <div style={{ display: 'flex', alignItems: 'center', gap: 6 }}>
                        ...
                        <span style={{ fontFamily: 'JetBrains Mono', fontWeight: 700, fontSize: 13, minWidth: 12, textAlign: 'center' }}>{qty}</span>
